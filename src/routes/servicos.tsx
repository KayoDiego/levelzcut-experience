...
export const Route = createFileRoute("/servicos")({
  head: () => ({
    meta: [
      { title: "Serviços — LevelzCut Pinheiros" },
      { name: "description", content: "Corte, barba, combo, sobrancelha, hidratação e pigmentação. Ritual premium com preço transparente." },
    ],
  }),
  component: Servicos,
});
